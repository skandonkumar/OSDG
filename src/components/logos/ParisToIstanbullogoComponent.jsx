...
import '../../CSS/logos/ParisToIstanbullogoComponent.css';

class ParisToIstanbulLogo extends Component {
    state = {  }
    render() { 
        return ( 
            <div className = "Logo-container">
                <h1 id="main-header">~ PARIS TO ISTANBUL ~</h1>
...
export default ParisToIstanbulLogo;