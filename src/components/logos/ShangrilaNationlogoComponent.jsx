...
import '../../CSS/logos/ShangrilaNationlogoComponent.css'


class ShangrilaNationLogo extends Component {
    state = {  }
    render() { 
        return ( 
            <React.Fragment>
                <div className = "Logo-container">
                    <h1 id="main-header">~ SHANGRI-LA NATION ~</h1>
...
export default ShangrilaNationLogo;